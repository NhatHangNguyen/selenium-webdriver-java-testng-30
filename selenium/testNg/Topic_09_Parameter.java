...
public class Topic_09_Parameter {
    ...
    public void beforeClass(String browserName, String browserVersion) {
        ...
        System.out.println("Browser " + browserName + "with version: " + browserName);
    ...
    public void TC_01_Login(String environmentName)  {
        driver.get(getEnvirnmentUrl(environmentName) + "/index.php/customer/account/login/");
    ...
    private String getEnvirnmentUrl(String environmentName){
        String urlValue;
